...
<head>
	...
	function doSubmit() {
		...
		document.getElementById("deptregisterform").submit();//document.forms[0].submit();과같다
		alert("부서 등록 되었습니다.");
	...
	<div id='pageContainer'>		
		...
		<div id='inputcontent'>
		    ...
		    <div id='inputmain'>
		        ...
		        <form id='deptregisterform' action='deptregister.action' method='post'><!-- 상대경로표시 -->
		        <table>
		        	<tr>
		            ...
		            <tr>
		                <th>부서명</th>
		                <td>
		                	<input type='text' name='partname' style='width:280px' />
		                </td>
		            </tr>	       
		        </table>
		        <div class='buttons'>
		        	...
		        	<input type='button' value='목록' style='height:25px'
		        		onclick="location.href='deptlist.action';" />
		        	<input type='button' value='취소' style='height:25px'
		        		onclick="location.href='deptregister.action';" />
		        </div>
		        </form>
		    </div>
		</div>

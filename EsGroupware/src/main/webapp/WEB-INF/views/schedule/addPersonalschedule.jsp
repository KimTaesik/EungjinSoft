	...
	<script type="text/javascript">
		$(document).ready(function(){
		    $('#day_day').click(function () {
		        if ($(this).is(':checked')) {
		        	$("#hour_s").hide();$("#min_s").hide();$("#hour_e").hide();$("#min_e").hide();
		        	$("#hour").hide();$("#min").hide();$("#duration_hour").hide();$("#duration_min").hide();
		        }
		    });
		...
		<table width="100%" border="0" cellspacing="1" cellpadding="3" bgcolor="#C9C9C9">
			<tr bgcolor="#FFFFFF" valign="middle"> 
				...
				<td style="padding-left:5px;">
					<input type=text id="schedule_title" maxlength=60 class="input" style="width:98%">
				</td>
			</tr>
			...
			<tr bgcolor="#FFFFFF">
				...
				<td style="padding-left:5px;">
					<textarea id="schedule_detail" class="memo" maxlength=512 style="width:100%;height:200px"></textarea>
				</td>
			</tr>
					...
					<select id="schedule_group" name=schedule_group class="input">
						<c:choose>
							<c:when test="${cate eq 'ps' || cate eq 'pus' }">
								<option value='closed' selected>=비공개=

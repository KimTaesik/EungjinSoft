...
<body>
	...
	<table id="menu" style="width: 500px;height: 110px;padding-left: 20px;text-align: center;color: white;">
		...
		<tr>
			<td onclick="window.open('/groupware/address/addressbooklist.action','주소록','left=100, top=100, toolbar=no, location=no, directories=no, status=no, menubar=no, scrollbars=yes, resizable=no, width=1150, height=650');">
